<?php
		...
		$Material = $FloorInfo->MaterialID;
		
		$Tile = new Material($Material , $db);
		$MaterialX = $Tile->MaterialWidth;
		$MaterialY = $Tile->MaterialHeight;
		
		$Long = $FloorInfo->longEstimate;
		$Width = $FloorInfo->widthEstimate;
		$StartX = $FloorInfo->StartPointX;
		$StartY = $FloorInfo->StartPointY;
		
		$ObjectWall = $FloorInfo->ObjectWall;
		...
		$reserve  = $FloorInfo->ReservePercent;
