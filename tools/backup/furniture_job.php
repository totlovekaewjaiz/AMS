...
<?
	if(count($AllProject) == 0) {
		...
		for($i = 0;$i < count($AllProject) ;$i++ ) {
			...
			<td class = "tableDataCenter"><? echo $AllHeroName[$i]->Type ; ?></td>	
			<td class = "tableDataCenter"><? echo $AllHeroName[$i]->Gender ; ?></td>			
			<td class = "tableDataCenter"><? echo $AllHeroName[$i]->Value; ?></td>	
