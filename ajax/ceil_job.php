<?
	...
	if($action == "saveJobInfo") {
		...
		$Job->CeilJobList["Material"] = $Material;
		$Job->CeilJobList["MaterialAmount"] = $MaterialAmount;
		$Job->CeilJobList["Long"] = $Long;
		$Job->CeilJobList["Width"] = $Width;
		$Job->CeilJobList["StartX"] = $StartX;
		$Job->CeilJobList["StartY"] = $StartY;
		$Job->CeilJobList["ObjectWall"] = $ObjectWall;
		$Job->CeilJobList["ObjectWidth"] = $ObjectWidth;
		$Job->CeilJobList["ObjectLong"] = $ObjectLong;
		$Job->CeilJobList["ObjectX"] = $ObjectX;
		$Job->CeilJobList["ObjectY"] = $ObjectY;
